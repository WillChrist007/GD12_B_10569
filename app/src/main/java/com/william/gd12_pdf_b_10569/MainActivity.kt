package com.william.gd12_pdf_b_10569
...
import com.william.gd12_pdf_b_10569.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String){
        ...
        val file = File(pdfPath, "pdf_10569.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.etanod)
